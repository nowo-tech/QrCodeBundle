...
Current stable: **v1.4.9** (2026-09-25).
...
git add -A
git status   # review
git commit -m "Release v1.4.9: FrankenPHP worker mode (no kernel reset) for database profiles"
git tag -a v1.4.9 -m "Release v1.4.9: FrankenPHP worker mode (no kernel reset) for database profiles"
