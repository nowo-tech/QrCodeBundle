...
namespace Nowo\QrCodeBundle\DependencyInjection\Compiler;
...
/**
 * Registers Twig paths with application override precedence (REQ-TWIG-001 / REQ-TWIG-002).
 */
final class TwigPathsPass implements CompilerPassInterface
{
    private const TWIG_NAMESPACE = 'NowoQrCodeBundle';
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        if ($container->hasParameter('kernel.project_dir')) {
            ...
            if (is_string($projectDirParam)) {
                ...
                $overridePath = $projectDir . '/templates/bundles/NowoQrCodeBundle';
